...
if [ "$1" = "-w" ] && [ "$2" -gt "0" ] && [ "$3" = "-c" ] && [ "$4" -gt "0" ]; then
        ...
        memTotal_b=`free -bw |grep Mem |awk '{print $2}'`
        memFree_b=`free -bw |grep Mem |awk '{print $4}'`
        memBuffer_b=`free -bw |grep Mem |awk '{print $6}'`
        memCache_b=`free -bw |grep Mem |awk '{print $7}'`

        memTotal_m=`free -mw |grep Mem |awk '{print $2}'`
        memFree_m=`free -mw |grep Mem |awk '{print $4}'`
        memBuffer_m=`free -mw |grep Mem |awk '{print $6}'`
        memCache_m=`free -mw |grep Mem |awk '{print $7}'`
